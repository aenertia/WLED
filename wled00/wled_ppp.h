...
// MRU advertised in LCP Configure-Request. Must differ from PPP_DEFMRU (1500)
// for lcp.c to include MRU in ConfReq. Set on ppp_pcb before listen/connect.
...
// UART RX buffer sized from MRU. HDLC byte-stuffing expands frames up to 2x
// (0x7D/0x7E escaping); buffer holds 2+ complete frames for sustained throughput.
...
// Bandwidth budget bytes/sec (8N1 = 10 bits/byte, ~15% PPP overhead)  -- used in diag warnings.
