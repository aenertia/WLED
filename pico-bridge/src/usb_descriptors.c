/*
 * USB descriptors for Pi Pico NCM-PPP Bridge
 * Based on TinyUSB net_lwip_webserver example (MIT License)
 * Adapted for WLED USB Bridge with NCM-only configuration.
 */

#include "bsp/board_api.h"
#include "tusb.h"

/* Auto ProductID using NCM bit */
...
tusb_desc_device_t const desc_device = {
    ...
    .bcdUSB             = 0x0201,  /* NCM requires USB 2.1 */
...
/*--------------------------------------------------------------------
 * BOS Descriptor (for Windows 10 NCM auto-driver)
 *--------------------------------------------------------------------*/
...
uint8_t const desc_ms_os_20[] = {
  ...
  /* MS OS 2.0 Compatible ID descriptor: WINNCM */
  U16_TO_U8S_LE(0x0014), U16_TO_U8S_LE(MS_OS_20_FEATURE_COMPATBLE_ID),
  'W', 'I', 'N', 'N', 'C', 'M', 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

  /* MS OS 2.0 Registry property descriptor: DeviceInterfaceGUIDs */
...
static char const *string_desc_arr[] = {
  ...
  [STRID_MANUFACTURER] = "WLED Project",
  [STRID_PRODUCT]      = "WLED USB Bridge",
  [STRID_SERIAL]       = NULL,  /* uses unique ID */
  [STRID_INTERFACE]    = "WLED NCM Network"
};
